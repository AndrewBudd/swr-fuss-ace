...
void boot_db( bool fCopyOver )
{
    ...
    */
   {
      ...
      ASSIGN_GSN( gsn_arkanian, "arkanian" );
    ...
    */
   {
      ...
      load_space(  );
      log_string( "Loading XML Space" );
      load_spacedb_xml( "space_db.xml"  );
      log_string( "Loading classic ships" );
      load_ships(  );
      ...
      log_string( "Loading instance prototypes" );
      sprintf( buf, "%sinstances.dat", SYSTEM_DIR );
      load_instance_file(buf);
